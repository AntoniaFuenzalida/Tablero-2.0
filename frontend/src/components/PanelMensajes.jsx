...
const PanelMensajes = ({ tableroId }) => {  const [mensajeActual, setMensajeActual] = useState(null);
  ...
  const fetchMensajes = useCallback(async () => {
    ...
    try {
      ...
      // Publicar mensaje en formato JSON también para tableros normales
      if (client && client.connected) {
        const mensajeJson = {
          text: texto,
          speed: velocidad,
      ...
      <div className="bg-white p-4 rounded-lg shadow">
        ...
        <div className="border-t pt-4">
          ...
          <div className="space-y-3">
            ...
            <div className="border border-gray-200 rounded-lg p-3 bg-gray-50 shadow-sm">              <div className="flex items-center justify-between mb-3">
